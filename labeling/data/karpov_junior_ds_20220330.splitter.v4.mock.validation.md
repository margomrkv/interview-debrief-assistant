...
- **splitter**: `labeling/data/karpov_junior_ds_20220330.splitter.v4.mock.json`
...
| Matched to splitter item | 21 / 21 | Splitter found a matching item within ±90s |
| **Coverage** | **100%** | Main signal: did the splitter extract every question? |
| Unmatched question chapters | 0 | Questions in video that splitter missed |
| Unmatched splitter items | 2 | Sub-questions / follow-ups extracted by splitter; no chapter in video — not an error |
| **Topic consistency** | **21/21 (100%)** | question_topic label matches the video section |
| Avg timing drift | 26.0s | Mean |item time − chapter time| for matched pairs |
...
| A/B-тесты | 6 | 6 | ✅ 0 | `Experimentation`, `Statistics` |
...
| 11 | `00:36:04` | Как быть, если нет старых пользователей, и нужно про | A/B-тесты | #12 | 00:36:03 | -1s | ✅ `Experimentation` |
| 12 | `00:42:04` | Вопрос про разницу Where и Having | Работа с данными | #13 | 00:43:16 | +72s | ✅ `SQL` |
| 13 | `00:44:20` | вопрос про виды join и задания на join | Работа с данными | #14 | 00:44:22 | +2s | ✅ `SQL` |
| 14 | `00:45:57` | подводка к задаче про group by в Python | Работа с данными | #15 | 00:44:49 | -68s | ✅ `SQL` |
| 15 | `00:47:49` | Задача на group by в Python | Работа с данными | #16 | 00:47:37 | -12s | ✅ `Python` |
| 16 | `01:06:22` | Задача о линейных регрессиях | ML алгоритмы | #17 | 01:07:00 | +38s | ✅ `ML` |
| 17 | `01:09:47` | Вопрос о градиентном спуске | ML алгоритмы | #19 | 01:09:49 | +2s | ✅ `ML` |
| 18 | `01:14:06` | Вопрос о переобучении | ML алгоритмы | #20 | 01:14:09 | +3s | ✅ `ML` |
| 19 | `01:22:20` | Вопрос о деревьях и их построении | ML алгоритмы | #21 | 01:22:19 | -1s | ✅ `ML` |
| 20 | `01:26:04` | Вопрос: почему случайный лес работает хорошо и не пе | ML алгоритмы | #22 | 01:26:05 | +1s | ✅ `ML` |
| 21 | `01:28:20` | Последний вопрос со звездочкой: в каких случаях логи | ML алгоритмы | #23 | 01:28:19 | -1s | ✅ `ML` |
...
**Coverage** 100% = 21 out of 21 question chapters were found by the splitter within ±90s.  
**Topic consistency** 100% = 21 out of 21 matched items have a `question_topic` label that matches the video section.
