...
- Если `args` пуст → AskUserQuestion с перечнем папок под `transcripts/mock-interviews/`, `transcripts/real-interviews/`, `transcripts/own/` (листья с `transcript.txt`).
...
```
user: /assess-interview transcripts/mock-interviews/avito/product-analyst-middle-avito-avito-2024-04-04
assistant:
