...
- Скрипт **жёстко отбрасывает** `junior_data_scientist_собеседование_karpov_courses_20220330` как дубль (согласовано пользователем 2026-05-16). Если кто-то добавит новый файл с таким `source_id` — он **тоже** будет отброшен. Это by design.
