...
Видение после встречи 2026-04-25 (команда проекта): инструмент строит **мост между субъективной стороной** (опыт, ценности, hard/soft skills конкретного кандидата) и **объективной стороной** (требования рынка, рубрики оценки, типовые вопросы).
...
| **S4** | Полный набор: профиль + JD + Transcript + Feedback | Структурированный отчёт по конкретному интервью с цитатами | Кандидат A: Company A/B и т.д. |
