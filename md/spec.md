...
| Кандидат A: Company A (без feedback) | ✓ | ✓ | ✓ | — | разбор без блока verdict (E4-4) | ✓ MVP (S4) |
| Кандидат A: Company B             | ✓ | ✓ | ✓ | ✓ | полный отчёт (E4-4) | ✓ MVP (S4) |
...
| **S4** | MF + KB | Полный набор: профиль + JD + Transcript + Feedback | Структурированный отчёт по конкретному интервью с цитатами | Кандидат A: Company A/B и т.д. | ✓ MVP (ядро) |
