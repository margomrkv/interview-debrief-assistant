...
| Anton: ApprovalMax (без feedback) | ✓ | ✓ | ✓ | — | разбор без блока verdict (E4-4) |
| Anton: интервью Avito             | ✓ | ✓ | ✓ | ✓ | полный отчёт (E4-4) |
...
| **S4** | MF + KB | Полный набор: профиль + JD + Transcript + Feedback | Структурированный отчёт по конкретному интервью с цитатами | Anton: интервью Avito, ApprovalMax и т.д. |
