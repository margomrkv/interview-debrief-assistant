<!-- PIPELINE_MANIFEST
{
  ...
  "updated_at": "2026-05-20 18:18:19 +0200",
  "models": {
    "step2_qa_extraction": {
  ...
  "artifacts": {
    "json": "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.json",
    "xlsx": "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.xlsx",
    "validation_report_md": "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.validation-report.md",
    "pipeline_log_md": "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.pipeline-log.md"
  },
  "llm_inputs": [
    {
      "step": 2,
      "name": "qa_extraction",
      "model": "claude-sonnet-4-6",
      "prompt_location": "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.pipeline-log.md#LLM_INPUT_STEP_2"
    },
    {
      "step": 5,
      "name": "semantic_validation",
      "model": "claude-sonnet-4-6",
      "prompt_location": "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.pipeline-log.md#LLM_INPUT_STEP_5"
    }
  ],
  "steps": [
    {
      ...
      "outputs": [
        "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.pipeline-log.md"
      ],
      "status": "completed",
      "duration_sec": null,
      "notes": null,
    ...
    },
    {
      ...
      "model": "claude-sonnet-4-6",
      "inputs": [
        "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.pipeline-log.md#LLM_INPUT_STEP_2"
      ],
      "outputs": [
        "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.json"
      ],
      "status": "completed",
      "duration_sec": 180.0,
      "notes": null,
      "finished_at": "2026-05-20 18:16:45 +0200"
    },
    {
      "id": 3,
      "name": "excel",
      ...
      "model": null,
      "inputs": [
        "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.json"
      ],
      "outputs": [
        "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.xlsx"
      ],
      "status": "completed",
      "duration_sec": 1.0,
      "notes": null,
      "finished_at": "2026-05-20 18:17:39 +0200"
    },
    {
      "id": 4,
      ...
      "outputs": [
        "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.validation-report.md"
      ],
      "status": "completed",
      "duration_sec": 1.0,
      "notes": null,
    ...
    },
    {
      ...
      "model": "claude-sonnet-4-6",
      "inputs": [
        "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.pipeline-log.md#LLM_INPUT_STEP_5"
      ],
      "outputs": [
        "splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.validation-report.md"
      ],
      "status": "completed",
      "duration_sec": 90.0,
      "notes": null,
      "finished_at": "2026-05-20 18:18:19 +0200"
    }
  ]
}
-->
...
- **Last updated:** 2026-05-20 18:18:19 +0200

Фильтр в IDE: `*ml-system-design-senior-karpov-v1-2021-08-03.v2*`
...
Write JSON only to: splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.json
...
======================================================================
Save JSON to: splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.json

Then (preferred — no LLM):
  scripts/splitter_post.sh splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.json \
    --video transcripts/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/video.md

Or manually:
  python3 .claude/skills/splitter/step3-excel/splitter_json_to_excel.py splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.json --out splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.xlsx

Validation (video.md offline only — never paste into the model):
  python3 .claude/skills/splitter/step4-validate-chapters/splitter_validate_video.py \
    --splitter splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.qa-split.json \
    --video transcripts/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/video.md \
    --tolerance 120 \
    --out splitter_output/mock-interviews/karpov/ml-system-design-senior-karpov-v1-2021-08-03/ml-system-design-senior-karpov-v1-2021-08-03.v2.validation-report.md
...
ITEM #4
  interviewer_question: time=00:10:52 text='что вообще здесь может быть что вам мы можем знать про баннеры вот эти вот рекламные картинка картинка и текст кто-кто-кто какая организация'
  candidate_answer: time=00:11:06 text='возможно мы можем кроме того описать что это напиток футболка косметика услуга так у нас есть это сайт на который ведет достаточно много всего вот почему мы можем построить какие признаки касаемые именно банеров вот соответственно признаки пользователя у нас тоже имеются поскольку это у нас социальная сеть признаки взаимодействия пользователей с баннером ну наверно там стоит посмотреть показывали ли мы ему до этого такой же баннер может быть какие то похожие'
  reference_answer: time=None text=None
...
ITEM #6
  interviewer_question: time=00:15:54 text='вот это хорош смотри что мы можем вообще оптимизировать в качестве бизнес метрики можно оптимизировать сетях можно оптимизировать покупки'
  candidate_answer: time=00:16:25 text='я думаю что вот стоит остановиться на чем-то одном из двух с покупками на дно может быть чуть сложнее потому что это более долгая история чем просто клик и как мне подсказывает интуиция не всегда наверное человек покупает вот данный товар с первого раза это правда'
  reference_answer: time=None text=None
  interviewer_feedback: time=00:16:46 text='знаешь какая система учится как раз на клики индекс цен ты читал я xd да понимаю я мать приводит к что учиться наклейки но можем учиться на клип'
...
ITEM #8
  interviewer_question: time=00:22:37 text='а если еще момент past papers of 10 инженеров а представь их не 10000 и представь каждый из них выкатил модель который реально ничем не отличается от как от контрольной группы что покажет как бы в таком случае'
  candidate_answer: time=00:23:15 text='ну может показать и прирост на самом деле и покажет если висение не сломаны и почему покажет ну потому что каждый этом смысле почему пока ну вот почему ты скоро может показать прирост хотим и знаешь там реально нет прирост ну нету прироста у каждой там печей отдельности но 1000 инженеров запустили тысячи моделей'
  reference_answer: time=None text=None
  interviewer_feedback: time=00:22:32 text='это реальная проблема которая возникает всегда как только вы начинаете каком-то множестве работать'
  question_topic: Experimentation
...
ITEM #12
  interviewer_question: time=00:32:54 text='что мы обучаем клики против не кликов кликов у нас сильно меньше соответственно нам нужно придумать вообще то есть крики понятно как доставать понятно что это такое а что такое не клики мы могли пользователю'
  candidate_answer: time=00:33:09 text='такое не клики мы могли пользователю показывает какое то объявление какой-то баннер и он мог его про скролить он мог его про скролить типа потому что он просто скрою или он мог построить потому что этому не интересно он мог на него пожаловаться вот то что человек жалуется на баннер и это нужно прям как какие-то hard негатива выносить что вот вот это ему показывать не надо ну пожаловаться скрыть там какие-то еще активности связанные прямо с неприятием рекламы вот соответственно если мы на майне на май нейм примерно одинаковое количество того что юзер кликал на баннер и юзер на баня жаловался или скрывал его на как раз получим какую-то более менее разметку который наверное сможем обучить бриз лайн так метрики есть данные накопали а финально как у тебя модель будет'
  reference_answer: time=None text=None
  interviewer_feedback: time=None text=None
  question_topic: ML
