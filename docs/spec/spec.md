...
| **S4** | AR + CC | Любой раунд интервью кандидата: профиль + JD + Transcript + опц. Feedback (mock или реальное интервью) | Структурированный отчёт по конкретному интервью с цитатами | Anton: интервью Avito, ApprovalMax, тренировочные mock'и | ядро |
