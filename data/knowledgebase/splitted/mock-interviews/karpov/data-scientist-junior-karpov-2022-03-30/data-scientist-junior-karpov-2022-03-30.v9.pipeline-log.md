<!-- PIPELINE_MANIFEST
{
  ...
  "started_at": "2026-05-20 12:08:07 +0200",
  "updated_at": "2026-05-20 12:49:58 +0200",
  "models": {
    "step2_qa_extraction": {
  ...
  "artifacts": {
    "json": "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.json",
    "xlsx": "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.xlsx",
    "validation_report_md": "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.validation-report.md",
    "pipeline_log_md": "splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.pipeline-log.md"
  },
  "steps": [
    {
      "id": 1,
      ...
      "outputs": [
        "splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.llm-input.txt",
        "splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.user-prompt.txt"
      ],
      "status": "completed",
      "duration_sec": null,
      "notes": null,
      "finished_at": "2026-05-20 12:08:07 +0200"
    },
    {
      "id": 2,
      "name": "qa_extraction",
      ...
      "outputs": [
        "splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.json"
      ],
      "status": "completed",
      "duration_sec": 300.0,
      "notes": "v8 base + item #6 speaker split (updated system prompt)",
      "finished_at": "2026-05-20 12:08:38 +0200"
    },
    {
      "id": 3,
      "name": "excel",
      ...
      "model": null,
      "inputs": [
        "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.json"
      ],
      "outputs": [
        "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.xlsx"
      ],
      "status": "completed",
      "duration_sec": 0.0,
      "notes": null,
      "finished_at": "2026-05-20 12:49:58 +0200"
    },
    {
      "id": 4,
      ...
      "outputs": [
        "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.validation-report.md"
      ],
      "status": "completed",
      "duration_sec": 1.0,
      "notes": null,
    ...
    },
    {
      ...
      "model": "claude-sonnet-4-6",
      "inputs": [
        "splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.validation.md"
      ],
      "outputs": [
        "splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.validation.llm.json"
      ],
      "status": "completed",
      "duration_sec": 60.0,
      "notes": null,
  ...
  "llm_inputs": [
    {
      ...
      "model": "claude-sonnet-4-6",
      "prompt_location": "splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.pipeline-log.md#LLM_INPUT_STEP_5"
    }
  ]
}
-->
...
- **Started:** 2026-05-20 12:08:07 +0200
- **Last updated:** 2026-05-20 12:49:58 +0200

Фильтр в IDE: `*data-scientist-junior-karpov-2022-03-30.v9*`
...
|---|------|-----|-------|----|-----|----------|--------|
| 1 | prepare | no | — | `transcripts/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/timecodes.txt`<br>`.claude/skills/splitter/step1-prepare/splitter_system_prompt.txt`<br>`.claude/skills/splitter/step1-prepare/splitter_output_schema.json` | `splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.llm-input.txt`<br>`splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.user-prompt.txt` | — | completed |
| 2 | qa_extraction | yes | claude-sonnet-4-6 | `splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.llm-input.txt` | `splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.json` | 300.0s | completed |
| 3 | excel | no | — | `/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.json` | `/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.xlsx` | 0.0s | completed |
| 4 | validate_chapters | no | — | `/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.json`<br>`/Users/mm/projects/ds-final-project/transcripts/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/video.md` | `/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.validation-report.md` | 1.0s | completed |
| 5 | llm_validation | yes | claude-sonnet-4-6 | `splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.validation.md` | `splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.validation.llm.json` | 60.0s | completed |
...
======================================================================
Save JSON to: splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.json

Then (preferred — no LLM):
  scripts/splitter_post.sh splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.json \
    --video transcripts/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/video.md

Or manually:
  python3 .claude/skills/splitter/step3-excel/splitter_json_to_excel.py splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.json --out splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.xlsx

Validation (video.md offline only — never paste into the model):
  python3 .claude/skills/splitter/step4-validate-chapters/splitter_validate_video.py \
    --splitter splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.qa-split.json \
    --video transcripts/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/video.md \
    --tolerance 120 \
    --out splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.validation.md
...
======================================================================
video.md: transcripts/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/video.md
...
ITEM #1
  interviewer_question: time=00:03:00 text='Изменяемые и неизменяемые типы данных в Python: что это вообще такое?'
  candidate_answer: time=00:03:08 text='Наверное, мне известны словари, которые мы единожды прописываем и далее не меняем; остальные, видимо, изменяемые типы данных. Я правильно понимаю?'
  reference_answer: time=None text=None
  interviewer_feedback: time=None text=None
  question_topic: Python

ITEM #2
  interviewer_question: time=00:03:26 text='Давай рассмотрим конкретно int, float, string, list, set, tuple и dict: что из этих семи изменяемые, что неизменяемые?'
  candidate_answer: time=00:04:06 text='Тьюплы, листы не меняемы, остальные меняемы. Dict - это словарь, это там где одно значение соответствует другому. Тьюплы - это не меняемый набор значений, насколько я помню. Все остальное, наверное, мы можем менять.'
  reference_answer: time=00:04:49 text='Int, float, string и tuple - неизменяемые. Изменяемые - list, dict и set. Если ты что-то делаешь с неизменяемыми данными, ты по сути пересоздаешь объект в памяти.'
...
ITEM #3
  interviewer_question: time=00:06:22 text='Вот такая функция принимает dict, пишет ключ z = 99, потом есть объект a, объект b как функция от a. Равны ли a и b?'
  candidate_answer: time=00:07:57 text='Потому что она выдаст true.'
  reference_answer: time=00:08:16 text='Да, действительно true. Это значит, что dict, который пришел на вход, изменился: a и b будут одним и тем же объектом, и в a мы тоже увидим z = 99.'
...
ITEM #4
  interviewer_question: time=00:10:40 text='Как мне сделать так, чтобы a у меня осталось как 1 a 2 b 3 c 4 d, а b было как 1 a 2 b 3 c 4 d z 99? Можешь ли ты изменить функцию или создание объекта b, чтобы разлепить эти два dict?'
  candidate_answer: time=00:13:11 text='Давай подумаем, что произойдет. Приравниваем значению b = a, видимо; описать его нужно сначала, потом в b добавится z = 99, возвращаем b, а у нас останется не тронут.'
  reference_answer: time=00:14:39 text='Нам нужно занять новый dict в памяти. Самый простой вариант - написать b = a.copy(). Можно сделать deep copy или внутри foo сделать новый словарь и вернуть его.'
...
ITEM #6
  interviewer_question: time=00:19:03 text='Очень часто еще спрашивают про генераторы, итераторы, декораторы в Python: что это такое, чем итератор от генератора отличается и вообще что такое декоратор?'
  candidate_answer: time=00:19:15 text='Я читала, все это знакомо, но на практике, может быть, что-то использовалось. Нет, не пользовался.'
  reference_answer: time=None text=None
  interviewer_feedback: time=00:19:31 text='Давайте я приведу только один пример декоратора: это когда мы перед функцией пишем такую собачку и название декоратора. Да, я понял.'
  question_topic: Python
...
ITEM #7
  interviewer_question: time=00:21:24 text='Представь, что у тебя есть рекомендательная модель. Product приходит и говорит: мы запустили новую модель и хотим оценить ее эффективность. Тебе нужно сделать дизайн эксперимента: на какие метрики смотреть, как делить людей на группы и как потом оценивать результат эксперимента.'
  candidate_answer: time=00:23:19 text='Первое - определяемся с метриками. Если говорить про рекомендательные системы, то, видимо, мы что-то рекомендуем, люди либо кликают, либо покупают; соответственно, это будут наши метрики: клики и покупки. Дальше хотим выбрать группы, на которых будем проводить эксперимент: одной группе будет показана старая рекомендательная система, другой - новая. Мы хотим, чтобы группы были однородными, чтобы не получилось так, что в одной группе только мальчики, а в другой только девочки; чтобы были сопоставимы возраст, география и остальные признаки. Понять, что группы одинаковые и подходят для эксперимента, мы можем A/A тестом. Кроме того, перед тем как приступить, нужно понять, какое количество наблюдений нам нужно, чтобы выводы имели вес; есть калькулятор, на курсах Карпова мы считали руками необходимый объем выборки. Потом, когда эксперимент проведен, мы сравниваем значения метрик статистическими тестами.'
  reference_answer: time=None text=None
  interviewer_feedback: time=00:28:32 text='Про дизайн эксперимента в целом все говоришь про меня: про метрики, про A/A тест, про расчет количества событий - это хорошо.'
  question_topic: Experimentation

ITEM #8
  interviewer_question: time=00:27:29 text='Вспомни метрики кейса: ты выбрал CTR и конверсию в покупку. Откуда там распределения? Хотелось бы чуть больше про тесты.'
  ...
  reference_answer: time=None text=None
  interviewer_feedback: time=00:28:48 text='Супер, что ты предложил минимум две метрики; по факту нужно предлагать чуть больше, но это уже клево.'
  question_topic: Experimentation

ITEM #9
  interviewer_question: time=00:30:44 text='Как мы можем сгенерировать распределение, исходя из наших выборок? Представь, что ты взял людей и поделил 50/50: как из них получить распределения конверсий?'
  candidate_answer: time=00:31:05 text='Мне кроме бутстрапа ничего быстро не приходит.'
  reference_answer: time=00:31:25 text='Если просто сравниваем цифры конверсии, используем chi-square. Но можно быстро бутстрапировать доли для всех кликов и конверсии в покупку и смотреть на эти распределения; по дефолту они будут нормальные, и для бутстрапированных конверсий можно применять тест.'
  interviewer_feedback: time=None text=None
...
ITEM #10
  ...
  reference_answer: time=00:32:31 text='Вопрос нормальности - точка спора. Мы можем использовать t-test и на ненормальных распределениях при определенных условиях; это предмет дискуссии, а не абсолютная истина.'
  interviewer_feedback: time=None text=None
  question_topic: Statistics
...
ITEM #11
  ...
  candidate_answer: time=00:33:51 text='Есть несколько тестов: Shapiro-Wilk, по-моему. В источниках описывается несколько, они все примерно равнозначны и дают похожий результат. Из того, что я делал, Shapiro-Wilk тест, наверное, все.'
  reference_answer: time=None text=None
  interviewer_feedback: time=00:34:15 text='Лучше всего иметь как минимум два ответа, но первый уже хорошо.'
  question_topic: Statistics
...
ITEM #12
  interviewer_question: time=00:34:27 text='Если у нас ненормальное распределение, как мы можем сравнить два ненормальных распределения?'
  candidate_answer: time=00:34:30 text='Есть непараметрические тесты. Один из них помнишь? - Манна-Уитни.'
  reference_answer: time=None text=None
  interviewer_feedback: time=00:34:43 text='В жизни применяют либо t-test, либо Mann-Whitney.'
  question_topic: Statistics

ITEM #13
  interviewer_question: time=00:34:45 text='Почему же у нас при бутстрэпировании средние будут в виде некоторого нормального распределения?'
  candidate_answer: time=00:35:31 text='Волшебная центральная предельная теорема.'
  reference_answer: time=None text=None
  interviewer_feedback: time=00:35:38 text='Супер.'
  question_topic: Statistics
...
ITEM #15
  interviewer_question: time=00:43:11 text='Если у нас есть group by и есть having, как работает having, как работает group by и чем они отличаются друг от друга?'
  candidate_answer: time=00:43:25 text='Синтаксически group by всегда будет перед having. Having накладывается на то, что сортировка group by сделала; group by - это уже агрегация.'
  reference_answer: time=None text=None
...
ITEM #16
  ...
  candidate_answer: time=00:44:27 text='Join, left join, right join, inner join и есть еще outer join.'
  reference_answer: time=None text=None
  interviewer_feedback: time=None text=None
  question_topic: SQL

ITEM #17
  interviewer_question: time=00:44:46 text='Представь, что у нас есть таблица A со 100 записями и таблица B с 50 записями, пересечение - 25 записей. Какое количество строк будет у left join, inner join, outer join и full join?'
...
ITEM #18
  interviewer_question: time=00:45:39 text='Есть еще cross join. О нем редко помнят. Что это такое?'
  candidate_answer: time=00:45:45 text='Это декартово произведение, то есть каждый с каждым. Она будет 100 на 50.'
  reference_answer: time=None text=None
...
ITEM #19
  ...
  reference_answer: time=00:46:18 text='Оконные функции - одно из самых частых, что спрашивается. Это минимум, который нужен даже для junior data analyst.'
  interviewer_feedback: time=00:46:16 text='Точнее, плохо.'
  question_topic: SQL

ITEM #20
  interviewer_question: time=00:47:46 text='Тебе нужно реализовать самую простую функцию, которая на вход принимает list a и b одинакового размера, а на выходе должна получить dict: ключи из b, а значения - сумма значений из a по этим ключам. Как бы ты это сделал?'
  candidate_answer: time=00:49:39 text='Ну, я бы видел это как цикл. Цикл, длину вот этого листа. В цикле я бы, обозначил три переменных, идя по циклу, обращаясь к самому простому if.'
  reference_answer: time=01:02:58 text='Можно создать пустой dict, потом пройтись по zip(a, b) и писать dt[g] = dt.get(g, 0) + i. Так работает простейшая group by sum.'
  interviewer_feedback: time=None text=None
  question_topic: Python
...
ITEM #21
  interviewer_question: time=01:06:53 text='Есть такие модели линейной регрессии. Можешь какую-нибудь вспомнить?'
  candidate_answer: time=01:07:00 text='Простая линейная регрессия: когда на вход подаем какие-то регрессоры, а на выходе получаем числовое значение, непрерывное.'
  reference_answer: time=None text=None
...
ITEM #23
  interviewer_question: time=01:07:20 text='A0 плюс bx - какие коэффициенты и с помощью чего мы их подбираем?'
  candidate_answer: time=01:07:29 text='Их подбираем, соответственно, блоком: константа и коэффициент при каждом регрессоре. Мы придумываем себе функцию ошибки. Есть среднеквадратичное, есть MAE. Это разница между тем, что на самом деле, и тем, что модель предсказала.'
  reference_answer: time=None text=None
  interviewer_feedback: time=01:07:57 text='Супер, уже супер. Расскажи поподробней.'
  question_topic: ML

ITEM #24
  interviewer_question: time=01:08:37 text='Почему мы считаем, что квадрат дает нам преимущество?'
  candidate_answer: time=01:08:40 text='Потому что квадрат дает нам параболу, и с параболой можно работать: она непрерывная, и в каком-то общем простом случае мы считаем, что у нее есть один минимум. Так мы можем подобрать параметры таким образом, чтобы наша ошибка оказалась внизу параболы. С математической точки зрения с квадратом работать проще, потому что легче дифференцировать.'
  reference_answer: time=None text=None
  interviewer_feedback: time=None text=None
  question_topic: ML

ITEM #25
  interviewer_question: time=01:09:15 text='Что происходит в MAE, когда мы берем модуль? Что там плохо?'
  candidate_answer: time=01:09:19 text='Константа остается, мыслить и сделать не сможем; в нуле это плохо, не дифференцируется.'
  reference_answer: time=None text=None
  interviewer_feedback: time=01:09:32 text='Супер.'
  question_topic: ML

ITEM #26
  interviewer_question: time=01:09:46 text='Я слышу, что есть такая вещь, как градиентный спуск. Что это за штука, что такое градиент и как это работает?'
  candidate_answer: time=01:10:07 text='Градиент - это производная; вектор градиента показывает изменения функции.'
  reference_answer: time=01:10:20 text='Градиент - это вектор частных производных. Он указывает направление возрастания функции; чтобы найти минимум, надо взять антиградиент.'
  interviewer_feedback: time=None text=None
  question_topic: ML
...
ITEM #27
  ...
  candidate_answer: time=01:11:05 text='У нас есть какая-то модель, мы получили по ней ошибки, взяли наш MSE. У нас какая-то функция, в какой-то точке мы находим вектор градиента и стремимся его свести к нулю. Если рисовать параболу, то мы стремимся по ней спуститься вниз в точку минимума ошибки.'
  reference_answer: time=01:12:07 text='Последовательность такая: сделал предсказание на текущих весах, посчитал ошибки, посчитал сумму квадратов ошибок, посчитал градиент, обновил веса и заново по циклу, пока ошибка не перестанет меняться.'
  interviewer_feedback: time=None text=None
  question_topic: ML
...
ITEM #28
  ...
  candidate_answer: time=01:14:25 text='Переобучение - это история, когда у нас модель на train-данных показывает какие-то хорошие результаты, а на тестовых данных показывает недостаточно хороший результат. Это история, когда модель подстраивается под нашу обучающую выборку, она прекрасно отрабатывает ее, но это не имеет отношения к жизни.'
  reference_answer: time=None text=None
  interviewer_feedback: time=None text=None
  question_topic: ML
...
ITEM #29
  ...
  candidate_answer: time=01:14:57 text='Регуляризация. Мы добавляем в функцию ошибки штрафующий член; если говорить о линейной регрессии, то он будет штрафовать и избавлять от больших весов предикторов.'
  reference_answer: time=None text=None
  interviewer_feedback: time=None text=None
  question_topic: ML

ITEM #30
  interviewer_question: time=01:16:51 text='Слышал ли ты про валидационные техники, когда есть train, test и validation, и про кросс-валидацию?'
  candidate_answer: time=01:17:07 text='Слышал про кросс-валидацию: когда у нас есть датасет, на котором мы учимся и тестируемся, и мы берем не просто одну часть как train, а другую как test, а меняем их, берем разные наборы; на разных наборах учимся, на разных тестируемся, но все в рамках одного датасета.'
  reference_answer: time=01:17:56 text='Это способ борьбы с переобучением: мы смотрим на кросс-валидации, как ведут себя метрики, и понимаем, переобучилась модель или нет.'
  interviewer_feedback: time=None text=None
  question_topic: ML

ITEM #31
  interviewer_question: time=01:18:37 text='Про стратификацию слышал?'
  candidate_answer: time=01:18:42 text='Мне кажется, мы хотим сделать так, чтобы в train-наборе были одинаково представлены какие-то подгруппы.'
  reference_answer: time=01:18:58 text='Да, в каждой валидации у нас должен быть определенный набор групп; это особенно актуально для multiclass-классификации.'
...
ITEM #32
  ...
  reference_answer: time=01:20:38 text='Общий вид следующий: есть период, на котором обучаемся, затем валидируемся на следующем куске, потом кумулятивно увеличиваем окно или двигаем его вперед и каждый раз делаем прогноз.'
  interviewer_feedback: time=None text=None
  question_topic: ML

ITEM #33
  interviewer_question: time=01:21:25 text='Еще один способ борьбы с переобучением, про который все забывают. Какой?'
...
ITEM #35
  ...
  reference_answer: time=01:26:47 text='Случайный лес работает тогда, когда каждый классификатор, каждое дерево, работает лучше случайного, то есть выше 0.5. Кроме того, мы используем bagging: случайное подмножество фичей и объектов, причем один и тот же объект может попадать несколько раз.'
  interviewer_feedback: time=None text=None
  question_topic: ML
...
ITEM #36
  interviewer_question: time=01:28:12 text='В каких случаях логистическая регрессия на задаче классификации будет работать лучше, чем случайный лес? Допустим, у нас сто пятьсот параметров и несколько миллионов объектов.'
  ...
  reference_answer: time=01:30:00 text='Именно: если в данных очень много шума, то случайный лес на случайных подмножествах фичей и объектов часто будет получать деревья около 0.5. А логистическая регрессия может отодвинуть шум и опереться на один-два незашумленных признака, по которым и разделит группы.'
  interviewer_feedback: time=None text=None
  question_topic: ML
...
(no items extracted)
SAVE JSON: вставьте ответ в конец файла splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v9.validation-report.md в секцию «Semantic validation (step 5)» (между <!-- SEMANTIC_VALIDATION --> и <!-- /SEMANTIC_VALIDATION -->, блок ```json).
