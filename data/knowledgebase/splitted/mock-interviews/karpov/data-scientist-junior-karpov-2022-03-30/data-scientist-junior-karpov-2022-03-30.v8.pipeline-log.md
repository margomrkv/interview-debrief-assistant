...
11) Transcript format handling: if transcript lines start with `[HH:MM:SS]` timestamps (e.g. `[00:05:12] word word word`), the transcript is a sequence of short timestamped fragments. When reconstructing a Q or A span:
   ...
   - CRITICAL — intra-line speaker changes: a single `[HH:MM:SS]` fragment may contain speech from TWO speakers when one speaker finishes and another begins within the same ~4–8 second window. Do NOT assume speaker changes always coincide with timecode boundaries. Use semantic analysis to detect the split point:
     ...
     * Phrases like "я читала", "я думаю", "ну", "давайте я приведу", "наверное ничего сказать" signal the candidate starting their turn.
     * Confirmations like "да", "хорошо", "супер", "нет не пользовался" often signal the candidate mid-turn or ending.
...
======================================================================
Save JSON to: splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v8.qa-split.json

Then (preferred — no LLM):
  scripts/splitter_post.sh splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v8.qa-split.json \
    --video transcripts/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/video.md

Or manually:
  python3 .claude/skills/splitter/step3-excel/splitter_json_to_excel.py splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v8.qa-split.json --out splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v8.qa-split.xlsx

Validation (video.md offline only — never paste into the model):
  python3 .claude/skills/splitter/step4-validate-chapters/splitter_validate_video.py \
    --splitter splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v8.qa-split.json \
    --video transcripts/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/video.md \
    --tolerance 120 \
    --out splitter_output/mock-interviews/karpov/data-scientist-junior-karpov-2022-03-30/data-scientist-junior-karpov-2022-03-30.v8.validation.md
