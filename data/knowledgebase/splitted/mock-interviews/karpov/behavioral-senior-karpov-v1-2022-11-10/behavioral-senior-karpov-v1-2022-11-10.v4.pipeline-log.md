<!-- PIPELINE_MANIFEST
{
  ...
  "started_at": "2026-05-20 17:38:14 +0200",
  "updated_at": "2026-05-20 17:40:25 +0200",
  "models": {
    "step2_qa_extraction": {
  ...
  "artifacts": {
    "json": "splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.json",
    "xlsx": "splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.xlsx",
    "validation_report_md": "splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.validation-report.md",
    "pipeline_log_md": "splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.pipeline-log.md"
  },
  "llm_inputs": [
    {
      "step": 2,
      "name": "qa_extraction",
      "model": "claude-sonnet-4-6",
      "prompt_location": "splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.pipeline-log.md#LLM_INPUT_STEP_2"
    },
    {
      "step": 5,
      "name": "semantic_validation",
      "model": "claude-sonnet-4-6",
      "prompt_location": "splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.pipeline-log.md#LLM_INPUT_STEP_5"
    }
  ],
  "steps": [
    {
      ...
      "outputs": [
        "splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.pipeline-log.md"
      ],
      "status": "completed",
      "duration_sec": null,
      "notes": null,
      "finished_at": "2026-05-20 17:38:14 +0200"
    },
    {
      "id": 2,
      "name": "qa_extraction",
      ...
      "status": "completed",
      "duration_sec": null,
      "notes": "12 items; transcript spans + chapter-reconstructed Q; speaker roles",
      "finished_at": "2026-05-20 17:39:49 +0200"
    },
    {
      "id": 3,
      "name": "excel",
      ...
      "model": null,
      "inputs": [
        "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.json"
      ],
      "outputs": [
        "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.xlsx"
      ],
      "status": "completed",
      "duration_sec": 1.0,
      "notes": null,
      "finished_at": "2026-05-20 17:40:09 +0200"
    },
    {
      "id": 4,
      ...
      "outputs": [
        "/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.validation-report.md"
      ],
      "status": "completed",
      "duration_sec": 0.0,
      "notes": null,
    ...
    },
    {
      ...
      "duration_sec": null,
      "notes": null,
      "finished_at": "2026-05-20 17:40:25 +0200"
    }
  ]
}
-->
...
- **Started:** 2026-05-20 17:38:14 +0200
- **Last updated:** 2026-05-20 17:40:25 +0200

Фильтр в IDE: `*behavioral-senior-karpov-v1-2022-11-10.v4*`
...
|---|------|-----|-------|----|-----|----------|--------|
| 1 | prepare | no | — | `transcripts/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/timecodes.txt`<br>`.claude/skills/splitter/step1-prepare/splitter_system_prompt.txt`<br>`.claude/skills/splitter/step1-prepare/splitter_output_schema.json` | `splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.pipeline-log.md` | — | completed |
| 2 | qa_extraction | yes | claude-sonnet-4-6 | — | — | — | completed |
| 3 | excel | no | — | `/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.json` | `/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.xlsx` | 1.0s | completed |
| 4 | validate_chapters | no | — | `/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.json`<br>`/Users/mm/projects/ds-final-project/transcripts/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/video.md` | `/Users/mm/projects/ds-final-project/splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.validation-report.md` | 0.0s | completed |
...
- **Forbidden:** putting the candidate's monologue into `interviewer_question` because it appeared at the chapter marker timestamp.
- **How to assign roles without speaker labels (mock behavioral interviews):**
  * Interviewer turn: short, directed at the candidate («как ты…», «а ты понимаешь…», «что делать…», «получается ты…»), often ends before a long story.
  * Candidate turn: long first-person story («я пошёл», «у нас было», «мы делали», «я бы сказал»), answers the posed question.
  * If a `[HH:MM]` line is clearly the candidate continuing a story, it is **never** the question — even if it is the first line in a YouTube chapter window.
- **Truncated / garbled ASR questions:** if the transcript fragment is an incomplete clause («…еще не Что», «…должен быть», «…справа будем сейчас манифест»), reconstruct a **complete** question:
  * use the **YouTube chapter title** from TIMECODES / chapter list when provided in sidecars;
  * or merge consecutive interviewer fragments until the question is intelligible;
  * do **not** copy the candidate's opening sentence into the question field.
- **Sanity check before output:** if the first ≥6 words of `candidate_answer` match the first words of `interviewer_question`, re-cut spans; if `interviewer_question` contains «я знаю / я просто / у нас / мы » without being a quote of the candidate, move that text to `candidate_answer`.
...
- GOOD Q: «Что делать, если в команде токсичный коллега?» (from chapter «Общение с токсичными коллегами») · GOOD A: only Kirill's reply from [31:24] onward («я с такими не встречался…»).
- BAD Q: «а ты понимаешь что повышать его еще не» · GOOD Q: «Понимаешь ли ты, что повышать карьериста рано — и что ты делаешь в такой ситуации?» (merge [32:36]+[32:40] interviewer lines).
...
======================================================================
Target version for this run: v4 only.
Write JSON only to: splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.json
...
======================================================================
Save JSON to: splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.json

Then (preferred — no LLM):
  scripts/splitter_post.sh splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.json \
    --video transcripts/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/video.md

Or manually:
  python3 .claude/skills/splitter/step3-excel/splitter_json_to_excel.py splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.json --out splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.xlsx

Validation (video.md offline only — never paste into the model):
  python3 .claude/skills/splitter/step4-validate-chapters/splitter_validate_video.py \
    --splitter splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.qa-split.json \
    --video transcripts/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/video.md \
    --tolerance 120 \
    --out splitter_output/mock-interviews/karpov/behavioral-senior-karpov-v1-2022-11-10/behavioral-senior-karpov-v1-2022-11-10.v4.validation-report.md
...
ITEM #4
  interviewer_question: time=12:13 text='Как твоя жизнь изменилась после этого после того как я пришел в Карпов курсе я так понимаю опять же я смотрю резюме что ты был руководителем напрямую людьми или руководишь руководитель или где наверное людьми где руководителями Как твоя жизнь'
...
ITEM #6
  interviewer_question: time=17:20 text='получается ты можешь сказать что ты сейчас успешно на работе вот я хочу сначала тебя понять хорошо говорит Кирилл ты очень плохо работает наверное это не успех правда ведь согласен А сейчас ты мне писал что команда мотивирована задачки Благо есть интересные кому-то то интересно кому-то это какое-то мы делаем общение с продуктом какие-то предоставляем вы чтобы люди себя обслуживали Вот и задаю вопрос'
  candidate_answer: time=17:59 text='что максимально успешно как я бы хотел но в целом как бы есть куда стремиться но в целом Я думаю я готов сказать что я доволен своей работы'
  reference_answer: time=None text=None
  interviewer_feedback: time=None text=None
  question_topic: Leadership
...
ITEM #8
  interviewer_question: time=22:29 text='А когда ты пришёл в karpov.courses, какие процессы и практики уже были?'
...
ITEM #11
  interviewer_question: time=31:21 text='Что делать, как жить — встречался ли ты на практике с токсичными коллегами?'
  candidate_answer: time=31:38 text='лично ни разу с такими не встречался поэтому я немного сложно говорить Как бы как бы я поступал на идеальный вариант когда такого человека от сети еще на собеседование идеальный вариант еще что то есть как бы у тебя нет какого-то регламента то есть разговаривайте по ходу за что-то зарубаетесь и ну и какое-то представление человека все равно можно ставить понятно что не всегда точно но прям какие-то выбросы можно заметить'
  reference_answer: time=None text=None
  interviewer_feedback: time=None text=None
  question_topic: Conflict
